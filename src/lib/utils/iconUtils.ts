...
/**
 * getChainIcon: Returns the icon URL for the specified chain. If no icon URL is provided, it returns a fallback URL.
 *
 ...
 * @example
 * // Example usage:
 * const chainIcon = getChainIcon("assets/networks/ethereum.svg");
 ...
 */
export function getChainIcon(iconUrl?: string) {
